...
const Pesanan = () => {
    ...
    const saveReceipt = (orderId, paymentDetails) => {
        const receiptData = {
            ...
            alamat: alamat,
            layanan: serviceName // Include the service name in the receipt
        };
    ...
    const submitOrder = () => {
        const orderData = {
            ...
            metode_pembayaran: paymentMethod,
            user_email: userEmail,
            layanan: serviceName // Include the service name in the order data
        };
    ...
    <label htmlFor="serviceName">Layanan: <br /></label>
    <input
        type="text"
        id="serviceName"
        className="form-input-pesanan input-layanan10"
